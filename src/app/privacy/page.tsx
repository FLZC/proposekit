...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl space-y-8 px-6 py-16">
      <h1 className="text-3xl font-semibold tracking-tight text-slate-800">Privacy Policy</h1>
      <p className="text-sm text-slate-500">Last updated: May 8, 2026</p>

      <section className="space-y-4 text-sm leading-7 text-slate-500">
        <h2 className="text-lg font-medium text-slate-800">1. Information we collect</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-500">
        <h2 className="text-lg font-medium text-slate-800">2. How we use your information</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-500">
        <h2 className="text-lg font-medium text-slate-800">3. Data storage, retention and security</h2>
        <p>
        ...
        <p>
          <strong className="text-slate-600">Data retention:</strong> We retain your account data
        ...
        <p>
          <strong className="text-slate-600">Third-party services:</strong>
        </p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-500">
        <h2 className="text-lg font-medium text-slate-800">4. Your rights and choices</h2>
        <p>
          You may request to <strong className="text-slate-600">access, correct, delete, or restrict
        ...
        <p>
          <strong className="text-slate-600">Do Not Sell My Personal Information:</strong> ProposeKit
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-500">
        <h2 className="text-lg font-medium text-slate-800">5. Changes to this policy</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-500">
        <h2 className="text-lg font-medium text-slate-800">6. Contact</h2>
        <p>
