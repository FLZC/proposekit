export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl space-y-8 px-6 py-16">
      <h1 className="text-3xl font-semibold tracking-tight text-slate-50">Terms of Service</h1>
      <p className="text-sm text-slate-400">Last updated: May 8, 2026</p>

      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">1. Acceptance of terms</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">2. Description of service</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">3. User responsibilities</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">4. Disclaimer of warranties</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">5. Limitation of liability</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">6. Beta terms</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">7. Changes to terms</h2>
        <p>
      ...
      <section className="space-y-4 text-sm leading-7 text-slate-400">
        <h2 className="text-lg font-medium text-slate-50">8. Contact</h2>
        <p>
