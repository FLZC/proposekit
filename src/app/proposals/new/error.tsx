  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl flex-col gap-8 px-6 py-12">
      <section className="space-y-3">
        ...
        <h1 className="text-3xl font-semibold tracking-tight text-slate-800 md:text-4xl">Create New Proposal</h1>
      </section>
      ...
      <div className="rounded-2xl border border-red-800/40 bg-red-950/30 p-8 text-center space-y-4">
        ...
        <h2 className="text-lg font-medium text-slate-800">Something went wrong</h2>
        ...
        <button
          type="button"
          onClick={reset}
          className="inline-flex min-h-10 items-center justify-center rounded-xl bg-amber-400 px-5 py-2 text-sm font-medium text-slate-900 transition hover:bg-amber-300"
        >
          Try again
        </button>
      </div>
