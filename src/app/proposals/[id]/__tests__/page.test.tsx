...
describe("ProposalWorkspacePage", () => {
  ...
  it("updates the proposal pricing line in place when pricing is regenerated", async () => {
    getProposalProjectById.mockResolvedValue({
      id: "project-123",
      client_name: "Northwind Studio",
      project_type: "website development",
    ...
    fireEvent.click(screen.getByRole("button", { name: "Regenerate pricing" }));

    expect(editor.value).toContain("Pricing: [Updated — regenerate to refine]");
  });
});
